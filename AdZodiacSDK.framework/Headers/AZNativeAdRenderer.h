 ...
 */
@protocol AZNativeAdRenderer <NSObject>
 ...
 */
- (instancetype)initWithRendererSettings:(id<AZNativeAdRendererSettings>)rendererSettings;
 ...
 */
- (UIView *)retrieveViewWithAdapter:(id<AZNativeAdAdapter>)adapter error:(NSError **)error;
...
/**
 * The AdZodiacSDK will notify your renderer when your native ad's view has moved in
...
/**
 *
 * The AdZodiacSDK will call this method when the user has tapped the ad and will
