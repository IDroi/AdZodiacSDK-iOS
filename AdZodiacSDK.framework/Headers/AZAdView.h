 ...
 */
- (void)adViewDidLoadAd:(AZAdView *)view;
 ...
 * @param view The ad view sending the message.
 */
- (void)adViewDidFailToLoadAd:(AZAdView *)view;
 ...
 */
- (void)willPresentModalViewForAd:(AZAdView *)view;
 ...
 */
- (void)didDismissModalViewForAd:(AZAdView *)view;
 ...
 * @param view The ad view sending the message.
 */
- (void)willLeaveApplicationFromAd:(AZAdView *)view;
