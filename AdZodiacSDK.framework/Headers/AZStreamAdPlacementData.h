...
@class AZNativeAdData;

@interface AZStreamAdPlacementData : NSObject

- (instancetype)initWithPositioning:(AZAdPositioning *)positioning;
- (void)insertAdData:(AZNativeAdData *)data atIndexPath:(NSIndexPath *)adjustedIndexPath;
...
- (AZNativeAdData *)adDataAtAdjustedIndexPath:(NSIndexPath *)adjustedIndexPath;
