...
@class AZNativeAd;
@class AZNativeAdRequest;
@class AZNativeAdRequestTargeting;

typedef void(^MPNativeAdRequestHandler)(AZNativeAdRequest *request,
                                      AZNativeAd *response,
                                      NSError *error);
...
@interface AZNativeAdRequest : NSObject
 ...
 */
@property (nonatomic, strong) AZNativeAdRequestTargeting *targeting;
 ...
 */
+ (AZNativeAdRequest *)requestWithAdUnitIdentifier:(NSString *)identifier
