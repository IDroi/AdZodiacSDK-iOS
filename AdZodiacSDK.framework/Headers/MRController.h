...
@property (nonatomic, readonly) AZWebView *mraidWebView;
@property (nonatomic, readonly) AZViewabilityTracker *viewabilityTracker;
...
- (void)handleMRAIDInterstitialDidPresentWithViewController:(AZMRAIDInterstitialViewController *)viewController;
