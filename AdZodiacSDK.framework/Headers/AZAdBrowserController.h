...
@interface AZAdBrowserController : UIViewController <MPWebViewDelegate, UIActionSheetDelegate>

@property (nonatomic, strong) IBOutlet AZWebView *webView;
...
- (void)dismissBrowserController:(AZAdBrowserController *)browserController animated:(BOOL)animated;
