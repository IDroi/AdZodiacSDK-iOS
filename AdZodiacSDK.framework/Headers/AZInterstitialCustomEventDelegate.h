//
//  AZInterstitialCustomEventDelegate.h
//  AdZodiac
//
...
@protocol AZInterstitialCustomEventDelegate <NSObject>
 ...
 */
- (void)interstitialCustomEvent:(AZInterstitialCustomEvent *)customEvent
                      didLoadAd:(id)ad;
 ...
 * instance of your custom event.
 */
- (void)interstitialCustomEventDidExpire:(AZInterstitialCustomEvent *)customEvent;
 ...
 *
 */
- (void)interstitialCustomEventWillAppear:(AZInterstitialCustomEvent *)customEvent;
 ...
 */
- (void)interstitialCustomEventDidAppear:(AZInterstitialCustomEvent *)customEvent;
 ...
 *
 */
- (void)interstitialCustomEventWillDisappear:(AZInterstitialCustomEvent *)customEvent;
 ...
 */
- (void)interstitialCustomEventDidDisappear:(AZInterstitialCustomEvent *)customEvent;
 ...
 *
 */
- (void)interstitialCustomEventDidReceiveTapEvent:(AZInterstitialCustomEvent *)customEvent;
 ...
 * instance of your custom event.
 */
- (void)interstitialCustomEventWillLeaveApplication:(AZInterstitialCustomEvent *)customEvent;
