...
@interface AZInterstitialCustomEvent : NSObject
...
@property (nonatomic, weak) id<AZInterstitialCustomEventDelegate> delegate;
@property (nonatomic, assign) NSString *networkType;
