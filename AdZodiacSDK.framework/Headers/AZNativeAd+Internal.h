...
@interface AZNativeAd (Internal)

@property (nonatomic, readonly) NSDate *creationDate;
@property (nonatomic) AZNativeView *associatedView;
@property (nonatomic, readwrite, strong) id<AZNativeAdRenderer> renderer;
@property (nonatomic, readonly) NSMutableSet *clickTrackerURLs;
@property (nonatomic, readonly) NSMutableSet *impressionTrackerURLs;
@property (nonatomic, readonly, strong) id<AZNativeAdAdapter> adAdapter;
