...
@interface AZStreamAdPlacer : NSObject
...
@property (nonatomic, readonly, copy) AZAdPositioning *adPositioning;
 ...
 *
 */
+ (instancetype)placerWithViewController:(UIViewController *)controller adPositioning:(AZAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
 ...
 */
- (void)loadAdsForAdUnitID:(NSString *)adUnitID targeting:(AZNativeAdRequestTargeting *)targeting;
...
@optional
- (void)adPlacer:(AZStreamAdPlacer *)adPlacer didLoadAdAtIndexPath:(NSIndexPath *)indexPath;
- (void)adPlacer:(AZStreamAdPlacer *)adPlacer didRemoveAdsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)nativeAdWillPresentModalForStreamAdPlacer:(AZStreamAdPlacer *)adPlacer;
 ...
 */
- (void)nativeAdDidDismissModalForStreamAdPlacer:(AZStreamAdPlacer *)adPlacer;
 ...
 */
- (void)nativeAdWillLeaveApplicationFromStreamAdPlacer:(AZStreamAdPlacer *)adPlacer;
