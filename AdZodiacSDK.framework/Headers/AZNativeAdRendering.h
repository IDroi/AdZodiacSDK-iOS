...
@class AZNativeAdRenderingImageLoader;
...
@protocol AZNativeAdRendering <NSObject>
 ...
 */
- (void)layoutCustomAssetsWithProperties:(NSDictionary *)customProperties imageLoader:(AZNativeAdRenderingImageLoader *)imageLoader;
