 ...
 * it has been tapped.
 */
@interface AZClosableView : UIView
...
- (void)closeButtonPressed:(AZClosableView *)closableView;

@optional

- (void)closableView:(AZClosableView *)closableView didMoveToWindow:(UIWindow *)window;
