 ...
 * @remark Any changes made to this bitmask should also be reflected in `AZViewabilityTracker`
 ...
 */
@interface AZViewabilityTracker : NSObject
 ...
 */
- (instancetype)initWithAdView:(AZWebView *)webView
