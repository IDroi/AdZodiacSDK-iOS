...
typedef NS_ENUM(NSInteger, AZLogEventScribeCategory) {
    MPExchangeClientEventCategory,
    MPExchangeClientErrorCategory,
};

typedef NS_ENUM(NSInteger, AZLogEventNetworkType) {
    AZLogEventNetworkTypeUnknown,
    AZLogEventNetworkTypeEthernet,
    AZLogEventNetworkTypeWifi,
    AZLogEventNetworkTypeMobile,
};

/*
 * Event names.
 */
extern NSString *const AZLogEventNameAdRequest;
extern NSString *const AZLogEventNameClickthroughDwellTime;

/*
 * Event categories.
 */
extern NSString *const AZLogEventCategoryRequests;
extern NSString *const AZLogEventCategoryNativeVideo;
extern NSString *const AZLogEventCategoryAdInteractions;
 ...
 */
@property (nonatomic, readonly) AZLogEventScribeCategory scribeCategory;
...
@property (nonatomic, readonly) AZLogEventNetworkType networkType;
...
- (instancetype)initWithAdUnitId:(NSString *)adUnitId networkId:(NSString *)networkId packageName:(NSString *)packageName adId:(NSString *)adId title:(NSString *)title;
...
- (instancetype)setRequestEvent;

- (instancetype)setFillEvent;

- (instancetype)setEmptyEvent;

- (instancetype)setImpressionEvent;
- (instancetype)setClickEvent;
- (instancetype)setConversionEvent;
