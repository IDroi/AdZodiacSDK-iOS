...
@protocol AZAdImpressionTimerDelegate <NSObject>
...
@interface AZAdImpressionTimer : NSObject

@property (nonatomic, weak) id<AZAdImpressionTimerDelegate> delegate;
...
/*
 * Initializes and returns an `AZAdImpressionTimer` instance which will alert its delegate when the given
