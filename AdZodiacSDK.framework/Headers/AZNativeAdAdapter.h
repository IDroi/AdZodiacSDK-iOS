 ...
 */
- (void)nativeAdWillPresentModalForAdapter:(id<AZNativeAdAdapter>)adapter;
 ...
 */
- (void)nativeAdDidDismissModalForAdapter:(id<AZNativeAdAdapter>)adapter;
 ...
 */
- (void)nativeAdWillLeaveApplicationFromAdapter:(id<AZNativeAdAdapter>)adapter;
 ...
 */
- (void)nativeAdWillLogImpression:(id<AZNativeAdAdapter>)adAdapter;
 ...
 * correct instance of your ad adapter.
 */
- (void)nativeAdDidClick:(id<AZNativeAdAdapter>)adAdapter;
 ...
 */
@protocol AZNativeAdAdapter <NSObject>
