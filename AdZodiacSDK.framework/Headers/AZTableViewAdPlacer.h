...
@interface AZTableViewAdPlacer : NSObject
 ...
 * @return An `MPTableViewAdPlacer` object.
 */
+ (instancetype)placerWithTableView:(UITableView *)tableView viewController:(UIViewController *)controller adPositioning:(AZAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
- (void)mp_setAdPlacer:(AZTableViewAdPlacer *)placer;
 ...
 */
- (AZTableViewAdPlacer *)mp_adPlacer;
 ...
 */
-(void)nativeAdWillPresentModalForTableViewAdPlacer:(AZTableViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdDidDismissModalForTableViewAdPlacer:(AZTableViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdWillLeaveApplicationFromTableViewAdPlacer:(AZTableViewAdPlacer *)placer;
