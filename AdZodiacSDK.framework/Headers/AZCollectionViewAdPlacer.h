...
@interface AZCollectionViewAdPlacer : NSObject
 ...
 * @return An `MPCollectionViewAdPlacer` object.
 */
+ (instancetype)placerWithCollectionView:(UICollectionView *)collectionView viewController:(UIViewController *)controller adPositioning:(AZAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
- (void)mp_setAdPlacer:(AZCollectionViewAdPlacer *)placer;
 ...
 */
- (AZCollectionViewAdPlacer *)mp_adPlacer;
 ...
 */
-(void)nativeAdWillPresentModalForCollectionViewAdPlacer:(AZCollectionViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdDidDismissModalForCollectionViewAdPlacer:(AZCollectionViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdWillLeaveApplicationFromCollectionViewAdPlacer:(AZCollectionViewAdPlacer *)placer;
