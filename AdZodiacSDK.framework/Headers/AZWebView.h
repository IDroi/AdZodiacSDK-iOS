...
- (BOOL)webView:(AZWebView *)webView
shouldStartLoadWithRequest:(NSURLRequest *)request
 navigationType:(UIWebViewNavigationType)navigationType;

- (void)webViewDidStartLoad:(AZWebView *)webView;

- (void)webViewDidFinishLoad:(AZWebView *)webView;

- (void)webView:(AZWebView *)webView
