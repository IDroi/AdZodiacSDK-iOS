...
@protocol AZBannerCustomEventDelegate <NSObject>
 ...
 */
- (void)bannerCustomEvent:(AZBannerCustomEvent *)event didLoadAd:(UIView *)ad;
 ...
 * Failure to do so will disrupt the mediation waterfall and cause future ad requests to stall.
 */
- (void)bannerCustomEvent:(AZBannerCustomEvent *)event didFailToLoadAdWithError:(NSError *)error;
 ...
 */
- (void)bannerCustomEventWillBeginAction:(AZBannerCustomEvent *)event;
 ...
 * `-bannerCustomEventDidFinishAction:` at a later point.
 */
- (void)bannerCustomEventDidFinishAction:(AZBannerCustomEvent *)event;
 ...
 *
 */
- (void)bannerCustomEventWillLeaveApplication:(AZBannerCustomEvent *)event;
