 ...
 */
@interface AZRewardedVideo : NSObject
 ...
 */
+ (AZRewardedVideoReward *)selectedRewardForAdUnitID:(NSString *)adUnitID;
 ...
 * message.
 */
+ (void)presentRewardedVideoAdForAdUnitID:(NSString *)adUnitID fromViewController:(UIViewController *)viewController withReward:(AZRewardedVideoReward *)reward;
 ...
 * message.
 */
+ (void)presentRewardedVideoAdForAdUnitID:(NSString *)adUnitID fromViewController:(UIViewController *)viewController withReward:(AZRewardedVideoReward *)reward customData:(NSString *)customData;
 ...
 */
- (void)rewardedVideoAdShouldRewardForAdUnitID:(NSString *)adUnitID reward:(AZRewardedVideoReward *)reward;
