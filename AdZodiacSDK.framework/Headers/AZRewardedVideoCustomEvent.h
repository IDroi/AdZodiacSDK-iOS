...
@interface AZRewardedVideoCustomEvent : NSObject
...
/**
 * Called when the AdZodiacSDK wants to know if an ad is currently available for the ad network.
 *
 ...
 */
- (void)rewardedVideoDidLoadAdForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 * Failure to do so will disrupt the mediation waterfall and cause future ad requests to stall.
 */
- (void)rewardedVideoDidFailToLoadAdForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent error:(NSError *)error;
 ...
 * instance of your custom event.
 */
- (void)rewardedVideoDidExpireForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 */
- (void)rewardedVideoDidFailToPlayForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent error:(NSError *)error;
 ...
 * Failure to do so will disrupt the mediation waterfall and cause future ad requests to stall.
 */
- (void)rewardedVideoWillAppearForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 */
- (void)rewardedVideoDidAppearForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 * Failure to do so will disrupt the mediation waterfall and cause future ad requests to stall.
 */
- (void)rewardedVideoWillDisappearForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 */
- (void)rewardedVideoDidDisappearForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 * instance of your custom event.
 */
- (void)rewardedVideoWillLeaveApplicationForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 * instance of your custom event.
 */
- (void)rewardedVideoDidReceiveTapEventForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
 ...
 */
- (void)rewardedVideoShouldRewardUserForCustomEvent:(AZRewardedVideoCustomEvent *)customEvent reward:(AZRewardedVideoReward *)reward;
 ...
 */
- (NSString *)customerIdForRewardedVideoCustomEvent:(AZRewardedVideoCustomEvent *)customEvent;
